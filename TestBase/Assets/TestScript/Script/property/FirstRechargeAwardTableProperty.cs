using System.Collections.Generic; 
 public class FirstRechargeAwardTableProperty
{
	public TableHeadInfo TResHeadAll;
	public List<FirstRechargeAwardTableObject> FirstRechargeAwardTable{ get; set;}
}
public class FirstRechargeAwardTableObject{

namespace com.kodgames.corgi.protocol
{
    ...
    [ProtoContract(Name="GC_BuyGuildPublicGoodsRes")]
    public class GC_BuyGuildPublicGoodsRes : IExtensible
    {
        private int _callback;
        private CostAndRewardAndSync _costAndRewardAndSync;
        private GuildPublicGoods _goods;
        private int _result;

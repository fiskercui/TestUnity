namespace com.kodgames.corgi.protocol
{
    ...
    [ProtoContract(Name="GC_GuildQueryMsgRes")]
    public class GC_GuildQueryMsgRes : IExtensible
    {
        ...
        [ProtoMember(5, IsRequired=false, Name="guildMsgCount", DataFormat=DataFormat.TwosComplement), DefaultValue(0)]

namespace com.kodgames.corgi.protocol
{
    ...
    [ProtoContract(Name="GC_MysteryShopBuyRes")]
    public class GC_MysteryShopBuyRes : IExtensible
    {
        private int _callback;
        private CostAndRewardAndSync _costAndRewardAndSync;
        private MysteryGoodInfo _goodsInfo;
        private int _result;
        ...
        [DefaultValue((string) null), ProtoMember(4, IsRequired=false, Name="goodsInfo", DataFormat=DataFormat.Default)]
        public MysteryGoodInfo goodsInfo
        {
            get
            {

namespace com.kodgames.corgi.protocol
{
    ...
    [ProtoContract(Name="GC_EquipBreakthoughtRes")]
    public class GC_EquipBreakthoughtRes : IExtensible
    {
        ...
        [DefaultValue((string) null), ProtoMember(3, IsRequired=false, Name="equipment", DataFormat=DataFormat.Default)]

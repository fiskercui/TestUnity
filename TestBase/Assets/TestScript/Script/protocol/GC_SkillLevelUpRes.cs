namespace com.kodgames.corgi.protocol
{
    ...
    [ProtoContract(Name="GC_SkillLevelUpRes")]
    public class GC_SkillLevelUpRes : IExtensible
    {
        ...
        [ProtoMember(3, IsRequired=false, Name="skill", DataFormat=DataFormat.Default), DefaultValue((string) null)]
        public Skill skill
        {
            get
            {

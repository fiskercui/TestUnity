namespace com.kodgames.corgi.protocol
{
    ...
    [ProtoContract(Name="GC_RefreshConstructionTaskRes")]
    public class GC_RefreshConstructionTaskRes : IExtensible
    {
        ...
        [DefaultValue((string) null), ProtoMember(3, IsRequired=false, Name="constructionInfo", DataFormat=DataFormat.Default)]

namespace com.kodgames.corgi.protocol
{
    ...
    [ProtoContract(Name="GC_CompleteConstructionTaskRes")]
    public class GC_CompleteConstructionTaskRes : IExtensible
    {
        ...
        [DefaultValue((string) null), ProtoMember(4, IsRequired=false, Name="constructionInfo", DataFormat=DataFormat.Default)]
        public ConstructionInfo constructionInfo
        {
            get
            {
                return this._constructionInfo;
            }
            set
            {
                this._constructionInfo = value;
            }
        }

namespace com.kodgames.corgi.protocol
{
    ...
    [ProtoContract(Name="GC_HireDinerRes")]
    public class GC_HireDinerRes : IExtensible
    {
        ...
        [DefaultValue((string) null), ProtoMember(3, IsRequired=false, Name="hiredDiner", DataFormat=DataFormat.Default)]

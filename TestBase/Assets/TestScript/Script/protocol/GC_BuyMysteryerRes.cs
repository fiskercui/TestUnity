namespace com.kodgames.corgi.protocol
{
    ...
    [ProtoContract(Name="GC_BuyMysteryerRes")]
    public class GC_BuyMysteryerRes : IExtensible
    {
        private int _callback;
        private CostAndRewardAndSync _costAndRewardAndSync;
        private MysteryerGood _goods;
        private int _result;
        ...
        [ProtoMember(3, IsRequired=false, Name="goods", DataFormat=DataFormat.Default), DefaultValue((string) null)]
        public MysteryerGood goods
        {
            get
            {
                return this._goods;

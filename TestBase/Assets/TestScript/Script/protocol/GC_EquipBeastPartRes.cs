namespace com.kodgames.corgi.protocol
{
    ...
    [ProtoContract(Name="GC_EquipBeastPartRes")]
    public class GC_EquipBeastPartRes : IExtensible
    {
        ...
        [DefaultValue((string) null), ProtoMember(4, IsRequired=false, Name="beast", DataFormat=DataFormat.Default)]
        public Beast beast
        {
            get
            {

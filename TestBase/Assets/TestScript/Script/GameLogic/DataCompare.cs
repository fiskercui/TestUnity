...
public static class DataCompare
{
	...
	public static int CompareLocationByShowPos(WeihuaGames.ClientClass.Location l1, WeihuaGames.ClientClass.Location l2)
	{
		return l1.ShowLocationId - l2.ShowLocationId;
	}

	public static int CompareBattlePosition(WeihuaGames.ClientClass.Avatar a1, WeihuaGames.ClientClass.Avatar a2)
	{
	...
	/// 5、	同品质同书籍同等级时，随机排序。
	/// </summary>
	//public static int CompareSkill(WeihuaGames.ClientClass.Skill s1, WeihuaGames.ClientClass.Skill s2)
	//{
	...
	//public static int CompareBeast(WeihuaGames.ClientClass.Beast b1, WeihuaGames.ClientClass.Beast b2)
	//{
	...
	/// 4、	同品质同书籍同等级时，随机排序。
	/// </summary>
	//public static int CompareSkillReverse(WeihuaGames.ClientClass.Skill s1, WeihuaGames.ClientClass.Skill s2)
	//{
	//	int lineuped1 = PlayerDataUtility.IsLineUpInPosition(SysLocalDataBase.Inst.LocalPlayer, s1) ? 1 : 0;
	//	int lineuped2 = PlayerDataUtility.IsLineUpInPosition(SysLocalDataBase.Inst.LocalPlayer, s2) ? 1 : 0;
	...
	/// 6、	同品质同书籍同等级时，随机排序。
	/// </summary>
	//public static int CompareSkillForLineUp(WeihuaGames.ClientClass.Skill s1, WeihuaGames.ClientClass.Skill s2)
	//{
	...
	//public static int CompareDanForLineUp(WeihuaGames.ClientClass.Dan d1, WeihuaGames.ClientClass.Dan d2)
	//{
	...
	//public static int CompareDanReverse(WeihuaGames.ClientClass.Dan d1, WeihuaGames.ClientClass.Dan d2)
	//{
	//	int lineuped1 = PlayerDataUtility.IsLineUpInPosition(SysLocalDataBase.Inst.LocalPlayer, d1) ? 1 : 0;
	//	int lineuped2 = PlayerDataUtility.IsLineUpInPosition(SysLocalDataBase.Inst.LocalPlayer, d2) ? 1 : 0;
	...
	public static int CompareQuestData(WeihuaGames.ClientClass.Quest q1, WeihuaGames.ClientClass.Quest q2)
	{
		//任务排列顺序
	...
	public static int CompareGuildTransferMember(WeihuaGames.ClientClass.GuildTransferMember m1, WeihuaGames.ClientClass.GuildTransferMember m2)
	{
		//if (m1.RoleId <= 0)
		//    m1.RoleId = ConfigDatabase.DefaultCfg.GuildConfig.GetRoleByRoleType(_RoleType.RoleType_Member).Id;
	...
	public static int CompaceApplyGuildRecord(WeihuaGames.ClientClass.GuildRecord m1, WeihuaGames.ClientClass.GuildRecord m2)
	{
	...
	public static int CompaceRankGuildRecord(WeihuaGames.ClientClass.GuildRankRecord m1, WeihuaGames.ClientClass.GuildRankRecord m2)
	{
